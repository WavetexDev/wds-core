...
const themeMode = getThemeMode(); /_ light | dark _/
...
const { primaryColor } = getSchoolColors(); /_ assuming primaryColor resolves to #000000 _/

const isPrimaryColorDark = isColorDark(primaryColor); /_ true _/
